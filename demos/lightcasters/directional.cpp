...
int main(void) {
    ...
    // SHADERS
    sjd::Shader lightingShader {"directional.vert.glsl", "directional.frag.glsl"};
    // ---
    ...
    lightingShader.setVec3("inlightDirection", -0.2f, -1.0f, -0.3f);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        // skip rendering to limit framerate
