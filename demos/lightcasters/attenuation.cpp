...
int main(void) {
    ...
    // SHADERS
    sjd::Shader lightingShader {"attenuation.vert.glsl", "attenuation.frag.glsl"};
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setVec3("alightPos", lightPos);
        uint16_t i {0};
        ...
        licubeShader.use();
        licubeShader.setVec3("lightColor", lightColor);
