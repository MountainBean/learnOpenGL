...
int main(void) {
    ...
    // SHADERS
    sjd::Shader modelShader("lighting.vert.glsl",
                            "lighting.frag.glsl");
    sjd::Shader visNormalsShader("vis_norms.vert.glsl",
                                 "vis_norms.frag.glsl",
                                 "vis_norms.geom.glsl");
    // ---
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        visNormalsShader.use();
        visNormalsShader.setMat4("model", model);
        visNormalsShader.setMat4("view", view);
        visNormalsShader.setMat4("projection", projection);
        backpack.Draw(visNormalsShader);
